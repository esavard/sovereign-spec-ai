...
**This example uses a deliberately fake placeholder domain ("Widget") that will never match a real blueprint.** It exists ONLY to teach you the required INDEX ORDERING and STRUCTURE. The blueprint you actually receive will describe a real, different domain — a meal-delivery platform, a CRM, a booking system, anything — with its own Ubiquitous Language (Order, Restaurant, Cart, Booking, whatever the Mermaid graph names). You MUST use the actual node names, prefixes, and vocabulary from the real blueprint. NEVER reuse "Widget", "Task", "Dexie", "IndexedDB", or any other noun from this example unless the real blueprint you were given literally contains that exact word — if you write the word "Widget" anywhere in your output, you have made a mistake.
...
[
  {"index": 1, "filename": "01_setup_widget_db.md", "title": "Setup Widget database", "context": "Mermaid node: DB_WidgetStore — no dependencies. Schema only, no repository.", "branch": "setup_widget_db"},
  {"index": 2, "filename": "02_widget_repository.md", "title": "Implement Widget repository", "context": "Mermaid node: R_WidgetRepo — depends on 01_setup_widget_db.md. CRUD only.", "branch": "widget_repository"},
  {"index": 3, "filename": "03_widget_aggregate.md", "title": "Implement Widget aggregate", "context": "Mermaid node: A_Widget — no dependencies (pure domain model, no persistence, no repository). Manages WidgetPart entities and publishes domain events.", "branch": "widget_aggregate"},
  {"index": 4, "filename": "04_widget_part_entity.md", "title": "Implement WidgetPart entity", "context": "Mermaid node: E_WidgetPart — depends on 03_widget_aggregate.md (pure domain model, no persistence, no repository).", "branch": "widget_part_entity"},
  {"index": 5, "filename": "05_widget_created_event.md", "title": "Implement WidgetCreated event", "context": "Mermaid node: DE_WidgetCreated — depends on 03_widget_aggregate.md, 04_widget_part_entity.md. Event data class only.", "branch": "widget_created_event"},
  {"index": 6, "filename": "06_widget_updated_event.md", "title": "Implement WidgetUpdated event", "context": "Mermaid node: DE_WidgetUpdated — depends on 03_widget_aggregate.md, 04_widget_part_entity.md. Event data class only.", "branch": "widget_updated_event"},
  {"index": 7, "filename": "07_create_widget_command.md", "title": "Implement CreateWidget command", "context": "Mermaid node: C_CreateWidget — depends on 03_widget_aggregate.md, 05_widget_created_event.md.", "branch": "create_widget_command"},
  {"index": 8, "filename": "08_update_widget_command.md", "title": "Implement UpdateWidget command", "context": "Mermaid node: C_UpdateWidget — depends on 03_widget_aggregate.md, 06_widget_updated_event.md.", "branch": "update_widget_command"},
  {"index": 9, "filename": "09_persist_widget_policy.md", "title": "Implement PersistWidget policy", "context": "Mermaid node: P_PersistWidget — depends on 02_widget_repository.md, 05_widget_created_event.md, 06_widget_updated_event.md. Subscribes to Event tasks only, calls the Repository task. Comes AFTER all commands because Policies are Group 6.", "branch": "persist_widget_policy"},
  {"index": 10, "filename": "10_widget_list_store.md", "title": "Implement WidgetListStore read model", "context": "Mermaid node: RM_WidgetList — depends on 05_widget_created_event.md, 06_widget_updated_event.md. Subscribes to Event tasks only, maintains in-memory state. Comes AFTER all commands and the Policy because Read Models are Group 7.", "branch": "widget_list_store"},
  {"index": 11, "filename": "11_widget_manager_ui.md", "title": "Implement WidgetManager UI", "context": "UI component — no Mermaid node (implicit). Depends on all Command tasks and the Read Model task. Wires user interactions to commands and renders read model state using the frontend framework.", "branch": "widget_manager_ui"}
]
